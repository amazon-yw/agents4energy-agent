...
필요한 시계열 데이터를 생성하고 각 풍력 발전소의 성과를 시각화할 수 있는 대시보드를 렌더링해주세요`,
    `샌후안 분지의 유정 압축기 단지에 대한 유지보수 일정을 최적화하는 데모를 만들어주세요. 
...
종합적인 보고서를 작성하고 시각화를 위해 렌더링해주세요.`,
    `저는 석유 탐사개발 회사의 완결 설계와 석유 생산 데이터를 비교합니다. 
10,000개 유정의 수압파쇄 완결 설계를 생성해주세요 (유정 간격, 수평 길이, 클러스터 간격, 펌핑된 물의 양, 펌핑된 프로판트 모래 파운드, 수압파쇄 단계 수). 
